...
--  This package implements a 'friendly' image function, that
--  doesn't put that darn space in front of positive numbers.
generic
   type Number is range <>;
function WL.Image (N : Number) return String;
